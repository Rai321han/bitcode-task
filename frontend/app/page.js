      ...
      <nav className=" bg-gray-100 sticky top-0 z-1000">
        <div className="flex flex-row justify-between items-stretch">
          <div className="flex flex-row gap-3 items-center">
            <div className="py-1 sm:py-2 px-4 font-extrabold text-primary bg-white">
              bitcode.
            </div>
          </div>
      ...
      <div className="overflow-hidden grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen  gap-16  font-[family-name:var(--font-geist-sans)]">
        <main className="flex flex-col  row-start-2 items-center sm:items-start w-full">
          <section className="min-h-[80vh] relative w-full flex flex-col gap-10 justify-center items-center">
            ...
            <div>
              <p className=" text-center text-xl sm:text-2xl text-dark">
          ...
          <section className="relative w-full flex flex-col gap-20 ">
            <div className=" w-full pb-10 border-t-1 border-t-grayline  bg-[linear-gradient(to_bottom,_white_50%,transparent_90%)]">
              <div className="max-w-[1000px] px-5 mx-auto flex flex-col-reverse tablet:flex tablet:flex-row gap-2">
                <div className="p-10">
                  <p className="text-normal-text  leading-tight text-md  sm:text-2xl max-w-[500px]">
